...
const AddTransactionForm = ({ accounts, categories, editMode = false, initialData = null }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
            <h1 className="text-5xl font-bold tracking-tight mb-10 text-center bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent">
            ...
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex gap-4 w-full">
                    ...
                    <Button 
                        type="submit" 
                        className="flex-1 transition duration-200 ease-in-out transform hover:scale-105 hover:bg-green-600"
